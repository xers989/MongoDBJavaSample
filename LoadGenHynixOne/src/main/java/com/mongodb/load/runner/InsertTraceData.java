...
public class InsertTraceData {
	...
	public void InsertLoadData() {
	    try{
	        ...
	        insertOneDocument(insertCollection, data);
	...
	public void InsertManyData() {
	    try{
	        ...
	        for(int i=0;i<100;i++)
	        	data.add(generateNewTransaction(new TraceData(sizeOfMeasure, sizeOfMessage))); 
